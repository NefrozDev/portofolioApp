const GLOSSARY_INFO_KEYS = {
  ...
  HTML: 'app.glossary.html',
  CSS: 'app.glossary.css',
  ...
  Jenkins: 'app.glossary.jenkins',
  Linux: 'app.glossary.linux',
  'Server Hardening': 'app.glossary.serverHardening',
  Monorepo: 'app.glossary.monorepo',
  'Access Control': 'app.glossary.accessControl',
